...
public class DataLoader {
    ...
    public DataLoader(ProdutoRepositorio ProdRep, ProdutoRepositorio produtoRepositorio) {
    ...
    public void init() {
        if(produtoRepositorio.count() == 0) {
            // public Produto(Long id, String nome, String tipo, String marca, Double custounit, Double porclucro, Integer quantidade, Double valorvenda) {
                ...
                produtoRepositorio.save(new Produto(null,"calça leggin","calça","Tommy", 25.0,90.0,4,500.0));
        }
    }
}
